    ...
    <Page title="Welcome!" wide={true}>
      <div className="row align-items-center">
        <div className="col-lg-7 py-3 py-md-5">
          <h2>
            <b>Your Voice, Your Privacy — Share Anonymously and Connect!</b>
          </h2>
          <br />
          <br />
          <p className="lead text-muted">Got something to say about your workplace? Whether it’s feedback, suggestions, or concerns, you can speak up here — completely anonymously.</p>
          <p className="lead text-muted">Our platform not only allows you to share your thoughts but also gives you the chance to chat with other users, all while staying anonymous. Start conversations, exchange ideas, and connect with your peers in a safe, private space.</p>
          <p className="lead text-muted">Your voice can make a difference. Let’s build a better workplace together — one anonymous conversation at a time.</p>
        </div>
